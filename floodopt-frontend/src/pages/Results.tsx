    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      ...
      {data.status === 'done' && (
        <div className="space-y-6">
          {/* P(t) grafiek */}
          {data.p_series && data.p_series.length > 0 && trajectory && (
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800 border-b pb-1 mb-3">Geselecteerde maatregelen</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800 border-b pb-1 mb-3">Financiële samenvatting</h2>
            <div className="grid grid-cols-2 gap-3 text-sm">
