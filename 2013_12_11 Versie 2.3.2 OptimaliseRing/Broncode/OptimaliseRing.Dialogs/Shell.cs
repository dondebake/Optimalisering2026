...
namespace ComponentAge.PlatformServices
{
   ...
   public interface IEnumIDList
   {
      ...
      [PreserveSig()]
      int Next(
          int celt,                // Number of elements in the array pointed to by the rgelt parameter.
      ...
      [PreserveSig()]
      int Skip(
          int celt                // Number of item identifiers to skip.
          );
   ...
   public interface IShellFolder
   {
    ...
    string pszDisplayName,  // Null-terminated UNICODE string with the
         // display name.
          out int pchEaten,      // Pointer to a ULONG value that receives the
         ...
         // the object.
          ref int pdwAttributes); // Optional parameter that can be used to
    ...
    ref Guid riid,      // Identifier of the COM interface object to
     ...
     out object ppv);    // Pointer to the requested interface.
      ...
      int GetDisplayNameOf(
         ...
         // folder.
          int /*SHGNO*/ uFlags,       // Flags used to request the type of display name
    ...
    string pszName,     // Pointer to a null-terminated string that
         // specifies the new display name.
          int /*SHGNO*/ uFlags,       // Flags indicating the type of name specified by
   ...
   public enum SHVIEW : int
   {
      SHVIEW_LARGEICON = 28713,
      SHVIEW_SMALLICON = 28714,
      SHVIEW_LIST = 28715,
      SHVIEW_REPORT = 28716,
      SHVIEW_THUMBNAIL = 28717,
      SHVIEW_TILE = 28718,
   }
}
