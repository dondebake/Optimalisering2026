...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/OptimaliseRing.UI/Program.cs 1     16/06/08 10:24 Ansink $
// $NoKeywords: $
#endregion
...
namespace OptimaliseRing.UI
{
  ...
  public static class Program
  {
    ...
    public static void Main()
    {
      ...
      {
        Steema.TeeChart.Languages.Dutch.Activate();
      }
      else if (cultureInfo.Name == "en-GB")
      {
        Steema.TeeChart.Languages.English.Activate();
      }
