...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/OptimaliseRing.General/Controls/Colorpicker/ComboBoxColorPicker.cs 1     16/06/08 10:24 Ansink $
// $NoKeywords: $
#endregion
...
namespace OptimaliseRing.Controls.ColorPicker
{
    ...
    public partial class ComboBoxColorPicker : ComboBox
    {
        ...
        /// <summary>
        /// The ColorPicker control that the combobox should hold
        /// </summary>
        ...
        /// <summary>
        /// Opens the drop down box with the ColorPicker
        /// </summary>
