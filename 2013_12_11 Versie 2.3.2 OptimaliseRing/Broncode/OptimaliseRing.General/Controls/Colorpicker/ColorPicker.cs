...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/OptimaliseRing.General/Controls/Colorpicker/ColorPicker.cs 1     16/06/08 10:24 Ansink $
// $NoKeywords: $
#endregion
...
using OptimaliseRing.Controls.ColorPicker.Util;
...
namespace OptimaliseRing.Controls.ColorPicker
{
  ...
  ToolboxItem(true),
 ToolboxBitmap(typeof(ColorPicker), "ColorPicker"),
  ...
  public partial class ColorPicker : UserControl
  {
    ...
    /// <summary>
    /// Gets or sets the selected color from the ColorPicker
    /// </summary>
   ...
   DefaultValue(typeof(Color), "System.Drawing.Color.Black")]
    ...
    /// <summary>
    /// Initialized a new instance of the ColorPicker in order to provide
    ...
    /// color picker control that could be used in a model or non-model form.
    /// </summary>
    /// <param name="startingColor">Starting color to the ColorPicker control</param>
    public ColorPicker(Color startingColor)
      : this()
    {
      Color = startingColor;
    }
    ...
    public void Show(Point startLocation)
    {
      ...
      _contextForm.Height = ColorPicker.PreferredHeight;
      _contextForm.Show(this, startLocation, ColorPicker.PreferredWidth);
    }
    /// <summary>
    /// Opens the control inside a context menu in the specified location
    /// </summary>
    ...
    public void Show(Control parent, Point startLocation)
    {
      ...
      frm.Height = ColorPicker.PreferredHeight;
      _contextForm = frm;
      frm.Show(parent, startLocation, ColorPicker.PreferredWidth);
    }
    /// <summary>
    /// Fires the ColorPicker.SelectedColorChanged event
    /// </summary>
    /// <param name="e"></param>
