...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/OptimaliseRing.General/Controls/Colorpicker/ToolStripColorPicker.cs 1     16/06/08 10:24 Ansink $
// $NoKeywords: $
#endregion
...
namespace OptimaliseRing.Controls.ColorPicker
{
    ...
    public class ToolStripColorPicker : ToolStripDropDownButton
    {
        ...
        /// ColorPicker control inside a ToolStripItem to add to ToolStrip containers.
        /// </summary>
