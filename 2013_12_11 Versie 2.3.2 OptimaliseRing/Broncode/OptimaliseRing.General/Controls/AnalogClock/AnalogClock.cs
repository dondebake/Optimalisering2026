...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/OptimaliseRing.General/Controls/AnalogClock/AnalogClock.cs 1     16/06/08 10:24 Ansink $
// $NoKeywords: $
#endregion
...
{
  [ToolboxBitmapAttribute(typeof(AnalogClock), "AnalogClock.bmp"),
  Description("Analog Clock Control")]
  public partial class AnalogClock : UserControl
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:AnalogClock"/> class.
    /// </summary>
    public AnalogClock()
    {
      InitializeComponent();
