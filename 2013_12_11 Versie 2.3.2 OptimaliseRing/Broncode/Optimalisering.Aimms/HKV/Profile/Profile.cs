...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/Optimalisering.Aimms/HKV/Profile/Profile.cs 3     31-03-09 10:30 Waterman $
// $NoKeywords: $
#endregion
...
namespace Hkv.Profile
{
  ...
  public abstract class Profile : IProfile
  {
    ...
    /// </summary>
    /// <param name="section">The name of the section that holds the entry.</param>
    /// <param name="entry">The name of the entry where the value will be set.</param>
    /// <param name="value">The value to set. If it's null, the entry should be removed.</param>
    /// <remarks>
        ...
        try
        {
          ...
          if (a == null)
          {
            ...
            if (a == null)
            {
              ...
              return Path.Combine(Path.GetDirectoryName(a.Location), Path.GetFileNameWithoutExtension(a.Location));
            }
          }
          return Path.Combine(Path.GetDirectoryName(a.Location), Path.GetFileNameWithoutExtension(a.Location));
        }
