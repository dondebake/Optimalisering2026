...
#region History ---------------------------------------------------------
// $Header: /Applicaties/Batch OptimaliseRing.root/OptimaliseRing/Optimalisering.Aimms/HKV/Profile/Ini.cs 2     30-03-09 13:16 Waterman $
// $NoKeywords: $
#endregion
...
namespace Hkv.Profile
{
  ...
  ///   This is cool=True
  ///   </code></remarks>
  public class Ini : Profile, IDisposable
  {
    /// <summary>
